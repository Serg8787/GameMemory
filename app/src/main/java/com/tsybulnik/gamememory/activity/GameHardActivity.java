...
public class GameHardActivity extends AppCompatActivity {
    ...
    private void frontOfCardsRecources() {
        ...
        image107 = R.drawable.sample107;
        image108 = R.drawable.sample108;
        ...
        image207 = R.drawable.sample207;
        image208 = R.drawable.sample208;
    ...
    private void calculate() {
        if (firstCard == secondCard) {
            ...
            } else if (clickedFirstCard == 12) {
                iv_41.setVisibility(View.INVISIBLE);

            } else if (clickedFirstCard == 13) {
                iv_42.setVisibility(View.INVISIBLE);

            } else if (clickedFirstCard == 14) {
                iv_43.setVisibility(View.INVISIBLE);

            } else if (clickedFirstCard == 15) {
            ...
            } else if (clickedSecondCard == 12) {
                iv_41.setVisibility(View.INVISIBLE);

            } else if (clickedSecondCard == 13) {
                iv_42.setVisibility(View.INVISIBLE);

            } else if (clickedSecondCard == 14) {
                iv_43.setVisibility(View.INVISIBLE);

            } else if (clickedSecondCard == 15) {
                iv_44.setVisibility(View.INVISIBLE);
    ...
    private void checkGame() {
        if (iv_11.getVisibility() == View.INVISIBLE &&
            ...
            AlertDialog.Builder alertBulder = new AlertDialog.Builder(GameHardActivity.this);
            alertBulder.setMessage("Конец игры")
                    ...
                    .setNegativeButton("Назад", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
                            Intent intent = new Intent(GameHardActivity.this, LevelActivity.class);
